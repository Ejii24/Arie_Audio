...
RUN pip install --no-cache-dir --index-url https://download.pytorch.org/whl/cu121 torch==2.5.1 torchaudio==2.5.1
RUN pip install --no-cache-dir transformers==4.48.0 librosa==0.10.2.post1 soundfile==0.12.1 numpy==1.26.4 pydantic==2.9.0 accelerate==0.34.2 huggingface-hub==0.27.0 runpod==0.10.5
